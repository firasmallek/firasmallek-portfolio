...
import {
    S as n
} from "./SplitText-11c87bed.js";
import {
    M as y
} from "./MorphSVGPlugin-93ba8eb9.js";
t.registerPlugin(u);
class P extends g {
    init() {
        this.DOM = {
            ...
            ease: "power2.out",
            duration: .6
        }, this.createTimeline(), this.initSquiggleMouseMovement()
    }
    ...
    createTimeline() {
        ...
        e.set([this.DOM.heading1, this.DOM.heading2], {
            ...
            e.add(this.char1()), e.add(this.char2(), .4), e.add(this.char3(), 1), e.add(this.char5(), .8), e.add(this.char6(), 1.1), e.add(this.char8to9(), 1.5), e.add(this.char10(), 1.7), e.add(this.char11(), 2), e.add(this.char12(), 1.9), e.add(this.char13(), 2.4), e.add(this.char15(), 2.2), e.add(this.buttonIn(), 1)
        })
    }
}
...
class T extends g {
    ...
    wordOne() {
        ...
        return t.set(this.DOM.stem, {
        ...
        }), a.add(this.staggerWord([s.chars, o.chars])), a.to(this.DOM.stem, {
            keyframes: [{
                drawSVG: "0% 100%",
                ease: "power4.inOut",
                duration: 1
        ...
        }, .8), a.fromTo([this.DOM.flairOne, this.DOM.flairTwo, this.DOM.flairThree], {
            y: 100,
            scale: 0,
            rotate: -180,
            transformOrigin: "50% 50%"
            ...
            duration: .8,
            stagger: .2
        }, .6), a.to([this.DOM.flairOne, this.DOM.flairTwo, this.DOM.flairThree], {
            autoAlpha: 0,
            y: -50,
            ease: "power2.in",
            duration: .6,
    ...
    createTimelines() {
        ...
        t.set(this.block, {
            ...
            e.add(this.wordOne()), e.add(this.wordTwo(), "-=1"), e.add(this.wordThree(), "-=.5")
        })
    }
}
...
class S extends g {
    ...
    createTimelines() {
        ...
        e.add("(prefers-reduced-motion: no-preference) and (min-width: 1240px)", () => {
            ...
            this.scrollTween = r, this.triggerDefaults.containerAnimation = this.scrollTween, this.intro(), this.basicWords(), this.niceAndEasyEasing(), this.hand(), this.semicircle(), this.personality(), this.huge(), this.superPlugAndPlay(), this.asterisk(), this.asteriskScrub(), this.curvedLineToggle(), this.customCurves(), this.animationSequences(), this.snap()
...
class b extends g {
    ...
    setIndexTools() {
        m(() => {
            this.setIndexToolsScroll(), this.setIndexToolsText(), this.setIndexToolsUi()
        })
    }
    playIndexTools() {
        m(() => {
            this.playIndexToolsScroll(), this.playIndexToolsSvg(), this.playIndexToolsText(), this.playIndexToolsUi()
        })
    }
    setIndexToolsScroll() {
...
new O;
//# sourceMappingURL=index-5d4939d4.js.map